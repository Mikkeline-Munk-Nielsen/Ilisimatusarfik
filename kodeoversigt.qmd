...
titanic <- df[rep(seq_len(nrow(df)), df$Freq), 1:4]
```
...
# Erstat variablene class og survived med navnene på dine variable
```
...
# Erstat udd og udd_partner med dine variable
```
...
# Erstat udd_aar og net_indkomst med dine variable
```
...
**H0**: forklaringskraften i model 3 er ikke singifikant højere end i model 2

**H1**: forklaringskraften i model 3 er singifikant højere end i model 2
