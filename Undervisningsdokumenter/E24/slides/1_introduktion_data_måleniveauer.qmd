...
![](images/udtraek.png){.right-align-image width="500px"}
...
Variable er byggestenene i statistiske analyser - det er dem, I kommer til at arbejde med som kollonner i jeres datasæt!
...
::: table-slide
| **Type** | **Variabel** | **Enhed** | **Værdi** | **Informationsniveau** |
|---------------|---------------|---------------|---------------|---------------|
| Nominal | Kommune | Borger | Kommune Kujalleq, Kommuneqarfik Sermersooq, Qeqqata Kommunia, Kommune Qeqertalik, Avannaata Kommunia. | Gensidigt udelukkende. Vi kan kun udtale os om, hvorvidt værdier er = eller ≠ hinanden. |
| Ordinal | Alderskategorier | Person | “Unge” (0-35 år), “middelaldrende” (36-54 år) eller ”ældre” (55+) | Kan rangordnes! Vi kan nu også se, om værdier er mindre \< eller større \> end andre. |
| Intervalskaleret | Temperatur | Lokation | -uendelig til +uendelig | Meningsfuld afstand mellem værdierne! Nu kan vi også addere (+) og subtrahere (-). Vi kan også måle tid, så længe, at 20 år er halvt så gammel som 40 år. Derfor kan vi multiplicere og dividere. |
:::
